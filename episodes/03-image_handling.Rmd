...
![Figure 1: Example image, rat cerebellum](fig/rat_cerebellum.png){#ratCerebellum}
...
```{python}
img_col = imread('fig/rat_brain_low_res.png')
...
```{python, results = 'hold'}
img_hr = imread('fig/rat_brain.png')
img_hr.shape
```
...
```{python, results = 'hold'}
img_pil = Image.open('fig/rat_brain.png')
...
img_task = imread('fig/rat_cerebellum.png')
```
